...
public class Constants {
	...
	public static final String TOP_T_MENUITEM_REPORT6 = "REPORTE POR ORDEN EN EL ESTADO: SUSPENDIDO BLOQUEADO";
	public static final String TOP_T_MENUITEM_REPORT7 = "REPORTE POR ORDEN EN EL ESTADO: SUSPENDIDO LISTO";
