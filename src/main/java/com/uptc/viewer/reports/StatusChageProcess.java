...
public class StatusChageProcess extends JDialog {

	private static final long serialVersionUID = 1L;
	private JPanel centerPanel, northPanel;
	private JTableData table;
	String [] headers = {"Accion", "Estado actual", "Estado nuevo"};

	public StatusChageProcess(ActionListener actionListener, JFramePrincipal jFramePrincipal) {
		setModal(true);
